...
const Home = () => {
  ...
  const HanldeSubmit= async (e)=>{
    ...
    await Postpassword(passworddata);
  ...
  return (
    <>
      <section className="min-h-screen w-full bg-gray-200 p-5 sm:p-3 ">
        ...
        action="" className="   w-full lg:w-1/2 mx-auto lg:transition-transform duration-200 mt-5 ease-in-out lg:hover:scale-105 bg-blue-400 flex gap-2 flex-col p-5 rounded-sm shadow-sm">
          ...
          <label htmlFor="username"  className="text-base text-gray-600 ">Username</label>
          <input
            type="text"
